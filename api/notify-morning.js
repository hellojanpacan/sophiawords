...
const MESSAGES = [
  ...
  { title: 'Buenos dias, Sophia!',          message: 'Tus palabras te esperan. ¡Vamos!' },
  { title: 'Un nuevo dia, nuevas palabras!',message: '5 minutos de práctica hacen la diferencia' },
  { title: 'Sophia, es hora!',              message: 'Cada palabra aprendida es un paso adelante' },
  { title: 'Lista para practicar hoy?',     message: '¿Lista para repasar tus palabras de hoy?' },
  ...
  { title: 'Desafiate hoy, Sophia!',        message: 'A ver cuántas palabras recuerdas hoy' },
